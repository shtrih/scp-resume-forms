                        ...
                        <ul class="collapsible blue-grey darken-3">
                            ...
                            <li>
                                ...
                                <div class="collapsible-body">
                                    ...
                                    <p>Минимальные требования для новых участников:</p>
                                    <ul class="browser-default">
                                        <li>Лицензионное ПО;</li>
                                        <li>Базовое знание нотной грамоты.</li>
                                    </ul>
                            ...
                            <li>
                                ...
                                <div class="collapsible-body">
                                    ...
                                    <ul class="browser-default">
                                        <li>
                                            Возраст 16+. Обусловлено необходимостью наличия сформировавшегося взрослого голоса;
                                        </li>
                                        <li>
                                            Речь должна быть без явных дефектов;
                                        </li>
                                        <li>
                                            Наличие студийного микрофона.
                                        </li>
                                    </ul>
